...
It allows sharing state down a component tree. This solution prevents prop drilling.
...
The Store is the object that brings the reducer and actions together. The store holds application state;
...
Redux-thunk action creators return functions instead of an action object.

5. What is your favorite state management system you've learned and this sprint? Please explain why!

I like redux. Because I know that it is very popular. And I like that it keeps things organized.
